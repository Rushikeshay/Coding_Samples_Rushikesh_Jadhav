...
# I used ChatGPT to write the following code. I asked "How to edit the values in 
# a variable starting a certain row by adding the same text.". ChatGPT taught me 
...
## ------------------------------------------------------------------------------------------------------
# I realized I left a typo, correcting it
...
# Clean data, convert to appropriate data type. I aksed chatgpt "how to convert 
# multiple columns to numeric and remove unwanted signs like "," and " " at ones. 
# It gave me similar function to that below. 
